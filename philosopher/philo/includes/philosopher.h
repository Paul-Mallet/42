...
typedef struct s_philo
{
    ...
    long long       last_meal_time;       // Timestamp of last meal(started before philos thread creations, updated during routine)
...
typedef struct s_data
{
	...
	pthread_mutex_t meal_mutex;        	  // For writing and reading meal timestamps safely
	pthread_mutex_t simulation_mutex;     // For synchronized console output
} t_data;
